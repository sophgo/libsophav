...
function build_vpu_driver()
{
    ...
    pushd ${BMVID_TOP_DIR}/provider/cnm/driver/linux
    pushd ${BMVID_TOP_DIR}/video/provider/cnm-wave-v5.6/vdi/linux/driver
...
function build_vpu_lib()
{
    ...
    #     if [ ${PRODUCTFORM} = soc ]; then
    #         pushd ${BMVID_TOP_DIR}/provider/cnm
    ...
    #     pushd ${BMVID_TOP_DIR}/provider/cnm/encoder
    #     make ${MAKE_OPT} PRO=0
    #     if [ $? -ne 0 ]; then
    #         popd
    #         return -1
    ...
    #     pushd ${BMVID_TOP_DIR}/video/encoder/wrapper/enc_wrapper_cnm
    #     make ${MAKE_OPT}
    #     if [ $? -ne 0 ]; then
    #         popd
    #         return -1
