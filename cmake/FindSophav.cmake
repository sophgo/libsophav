...
function(ADD_TARGET_YUV_LIB target_name platform debug component yuv_abs_path)
    ...
    set(YUV_LIB_TARGET ${yuv_abs_path}/libyuv/lib/libyuv.so)
    set(YUV_ALIB_TARGET ${yuv_abs_path}/libyuv/lib/libyuv.a)
    set(YUV_HEADER_TARGET ${yuv_abs_path}/libyuv/include)
    set(YUV_BIN_TARGET ${yuv_abs_path}/libyuv/bin/yuvconvert)
    ...
    add_custom_command(OUTPUT ${YUV_LIB_TARGET} ${YUV_ALIB_TARGET} ${YUV_HEADER_TARGET} ${YUV_BIN_TARGET}
        ...
        COMMAND rm -rf ./build/*
        COMMAND ${CMAKE_COMMAND} -E chdir ./build ${CMAKE_COMMAND} ${CMAKE_OPTION} -DCMAKE_INSTALL_PREFIX=${yuv_abs_path}/libyuv ..
        COMMAND ${CMAKE_COMMAND} -E chdir ./build make -j`nproc`
        COMMAND ${CMAKE_COMMAND} -E chdir ./build make install
        COMMAND ${CMAKE_COMMAND} -E copy_if_different ./build/yuvconvert ${yuv_abs_path}/libyuv/bin/yuvconvert
    ...
    install(DIRECTORY ${yuv_abs_path}/libyuv/lib/
        DESTINATION lib
        FILE_PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ GROUP_EXECUTE WORLD_READ WORLD_EXECUTE
        COMPONENT ${component}
        FILES_MATCHING
