...
int main(int argc, const char * argv[])
{
    ...
    vg_lite_float_t w0 = 0.2;
    vg_lite_float_t w1 = 0.1;
    vg_lite_float_t w2 = 0.1;
    ...
    feature_check = vg_lite_query_feature(gcFEATURE_BIT_VG_GAUSSIAN_BLUR);
    if (!feature_check) {
        printf("gaussian_blur3x3 is not supported.\n");
        cleanup();
        return -1;
    }  
