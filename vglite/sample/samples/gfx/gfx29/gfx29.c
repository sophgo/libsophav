...
int main(int argc, const char * argv[])
{
    ...
    vg_lite_blit2(&yuv_buffers[0], &img_buffer, &paint_buffer,
                  &mat_bg, &mat_src, VG_LITE_BLEND_SRC_OVER, filter);
    ...
    vg_lite_scale((vg_lite_float_t) fb->width / FB_WIDTH,
                  (vg_lite_float_t) fb->height / FB_HEIGHT, &mat_yuv[0]);
