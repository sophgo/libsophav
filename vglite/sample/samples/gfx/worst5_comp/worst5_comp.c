...
int main(int argc, const char * argv[])
{
    ...
    buffer.format = VG_LITE_YUY2_TILED;
    error = vg_lite_allocate(&buffer);
    buffer1.format = VG_LITE_BGRA8888;
    ...
    vg_lite_blit(&buffer1, fb, &matrix2, VG_LITE_BLEND_NONE, 0, filter);
    vg_lite_finish();
    /* Save PNG file. */
    vg_lite_save_png("worst5_comp.png", &buffer1);
    if (error) {
