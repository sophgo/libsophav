...
int main(int argc, const char * argv[])
{
    ...
    for (loops = 0; loops < frames; loops++)
    {
        ...
        render_clock(&image_buffer, -160, 0, 0, 15, 8);
        render_buttons(&image_buffer, -160, 0);
        ...
        render_clock(&image_buffer2, 160, 0, 6, 15, 22);
        render_buttons(&image_buffer2, 160, 0);
    ...
    vg_lite_finish();
    /* Save PNG file. */
    vg_lite_save_png("worst_2.png", fb);
    /* Cleanup. */
    cleanup();
    return 0;
}
