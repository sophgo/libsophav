...
static vg_lite_buffer_t buffer, image_buffer, image_buffer2, render_buffer;
...
vg_lite_error_t createBuffers()
{
    ...
    render_buffer.format = VG_LITE_BGRA8888;
...
int main(int argc, const char * argv[])
{
    ...
    if (!vg_lite_load_png(&image_buffer, "landscape1.png")) {
        printf("vg_lite_load_png() coud not load the image '1.png'\n");
        cleanup();
        return -1;
    }
    ...
    {
        /* Clear the buffer. */
        vg_lite_clear(&image_buffer, NULL, 0xFFFF0000);
    ...
    vg_lite_finish();
    /* Save PNG file. */
    vg_lite_save_png("worst_3_uncomp.png", fb);
