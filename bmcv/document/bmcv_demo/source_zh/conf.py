...
#
# html_theme_options = {
#     'prev_next_buttons_location': 'bottom',  # 显示导航按钮在底部
#     # 其他主题选项...
# }
...
latex_elements = {
    ...
    \fancypagestyle{normal}{
        \fancyhead[L]{\includegraphics[width=3cm,height=1cm]{../../../bmcv_common/images/header_logo.png}}
        \fancyhead[R]{}
        \fancyfoot[C]{\thepage}
    ...
    'maketitle': "\\input{../../../bmcv_common/cover.tex}",
...
# latex_logo = '../../bmcv_common/images/logo.png'
