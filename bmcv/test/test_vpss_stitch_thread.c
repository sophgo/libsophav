...
char *src_name = "/opt/sophon/libsophon-current/bin/res/1920x1080_yuv420.bin", *dst_name = "out/stitch_1920x2160_yuv420.bin";
...
char *md5 = "e87a217980cb993f9c404147247c8900";
...
static void print_help(char **argv){
    printf("please follow this order:\n \
        %s src_w src_h src_fmt src_name start_x0 start_y0 crop_w0 crop_h0 start_x1 start_y1 crop_w1 crop_h1 dst_w dst_h dst_name dev_id thread_num loop_num md5\n \
