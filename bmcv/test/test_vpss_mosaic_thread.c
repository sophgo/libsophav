...
char *src_name = "/opt/sophon/libsophon-current/bin/res/1920x1080_rgb.bin", *dst_name = "out/mosaic_1920x1080_rgb.bin";
bmcv_rect_t rect = {.start_x = 100, .start_y = 100, .crop_w = 500, .crop_h = 500};
bmcv_resize_algorithm algorithm = BMCV_INTER_LINEAR;
bm_handle_t handle = NULL;
char *md5 = "8e8dd4c881d32bd9555e62b46f8c900c";

static void * mosaic(void* arg) {
    bm_status_t ret;
    ...
    printf("idx:%d, bmcv_image_mosaic:loop %d cycles, time_max = %llu, time_avg = %llu, fps %llu, %lluM pps\n",
...
static void print_help(char **argv){
    printf("please follow this order:\n \
        %s src_w src_h src_fmt src_name start_x start_y mosaic_w mosaic_h dst_name dev_id thread_num loop_num md5\n \
