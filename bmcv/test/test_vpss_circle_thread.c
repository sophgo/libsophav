...
char               *md5      = "583e2f078ceccfa73b4b084d7cf74aca";

static void *circle(void *arg) {
    bm_status_t        ret;
    ...
    for (i = 0; i < loop_time; i++) {
        ...
        ret = bmcv_image_circle(handle, src, center, radius, color, line_width);
    ...
    printf("idx:%d, bmcv_image_circle: loop %d cycles, time_max = %llu, time_avg = %llu, fps %llu, %lluM pps\n",
...
static void print_help(char **argv) {
    printf("please follow this order:\n \
        %s src_w src_h src_fmt src_name center_x center_y radius line_width dst_name dev_id [thread_num] [loop_num] [md5]\n \
