...
DECL_EXPORT bm_status_t bmcv_tde_convert(
    ...
    int            rot_angle = 0,
    int            global_alpha = 0,
    bmcv_rect_t*   src_rect = NULL,
    bmcv_rect_t*   dst_rect = NULL);
...
DECL_EXPORT bm_status_t bm_image_dev_mem_alloc(bm_image image, int heap_id = BMCV_HEAP_ANY);
