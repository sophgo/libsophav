...
/**
@verbatim
This command adds PPS header syntax of H.264/AVC bitstream
...
/**
@verbatim
This command sets active PPS header syntax of H.264/AVC bitstream, and `parameter` is interpreted
...
/**
@verbatim
This command gets active PPS header syntax of H.264/AVC bitstream, and `parameter` is interpreted as an active PPS index.
...
*/
    ...
    ENC_SET_MIN_MAX_QP, /**< This command sets a maximum delta QP and maximum/minimum QP values of intra picture for rate control. (CODA9 encoder only)*/
    ENC_SET_PIC_CHANGE_PARAM, /**< This command sets a picture parameter. (CODA9 encoder only)*/
    ENC_SET_RC_LIBRARY, /**< This command sets a rate control library. (CODA9 encoder only)*/
...
/**
 * @brief    This is a data structure for setting output scaler parameters.
 */
typedef struct {
    BOOL   enScaler;    /**< It indicates an enable flag of scaler. */
    Uint32 scaleWidth;  /**< It indicates a width of scaler. */
    Uint32 scaleHeight; /**< It indicates a height of scaler. */
/**
@verbatim
It indicates a coefficient mode of scaler. (WAVE6 only)

* 0  : Bicubic sharpness parameter 0.5.
* 1  : Bicubic sharpness parameter 1.0.
* 2  : Bicubic sharpness parameter 1.5.
* 3  : Lanczos-2.
@endverbatim
*/
    Uint32 scaleMode;
...
typedef struct {
    union {
        ...
        struct {
            // for Decoder
            int useSclEnable; /**< This enables AXI secondary channel for Scaler line buffer. (WAVE5 only) */
            int useBitEnable;   /**<  This enables AXI secondary channel for prediction data of the BIT-processor. */
            int useIpEnable;    /**<  This enables AXI secondary channel for row pixel data of IP. */
...
*/
    ...
    int mvcExtension;       /**< It this field is 1, MVC encoder is enabled.  */
    int interviewEn;        /**< If this field is 1, MVC encoder uses interview prediction for encoding a non-base view of anchor picture. */
    int parasetRefreshEn;   /**< If this field is 1, SPS/PPS are inserted in front of every anchor picture. */
    int prefixNalEn;        /**< If this field is 1, MVC encoder inserts prefix NAL unit in front of every slice nal unit of base view. */
...
/**
@verbatim
It specifies reference mode for interlaced field encoding(avc_field_flag is 1).
...
@* 0 : YUV420 format
@* 1 : YUV400 monochrome format
@endverbatim
*/  int chromaFormat400;
    int ppsNum;     /**< The total number of PPS(Picture Parameter Set) to encode  */
    AvcPpsParam ppsParam[MAX_ENC_PPS_NUM]; /**< <<vpuapi_h_AvcPpsParam>> */
} EncAvcParam;
...
/**
@verbatim
Intra MB count enable (CODA9 only)

If it is enabled (default: 0), VPU does not count intra MBs which are decided and encoded
by mode decision when counting IntraMbRefreshNum. This option is valid only when
...
/**
@verbatim
Field sequence intra refresh enable (CODA9 only)

This option is valid only when IntraMbRefreshNum[15:0] is not 0 and interlaced encoding.

@* 0 : Field sequence intra refresh is disabled.
...
*/
    ...
    int             userQpMinI;      /**< The minimum quantized step parameter for Intra frame. (H.264/AVC only) */
    int             userQpMinP;      /**< The minimum quantized step parameter for Inter frame. (H.264/AVC only) */
    int             userQpMaxI;    /**< The maximum quantized step parameter for Intra frame. (H.264/AVC only) */
    int             userQpMaxP;    /**< The maximum quantized step parameter for Inter frame. (H.264/AVC only) */
...
/**
@verbatim
Enable or disable frame buffer cache (CODA9 only)
...
/**
@verbatim
Cache way size of luma and chroma. (CODA9 only)
This value range is from 0 to 15.

[0-15] {chroma[1:0], luma[1:0]}

@* Luma
@** 2b'00 or 2b'01 : 64x64
@** 2b'10 or 2b'11 : 128x32
@* Chroma Separated
@** 2b'00 or 2b'01 : 32x32
@** 2b'10 or 2b'11 : 64x16
@* Chroma Interleaved
@** 2b'00 or 2b'01 : 32x64
@** 2b'10 : 64x32
@** 2b'11 : 128x16
@endverbatim
*/
...
*/
    ...
    int             set_dqp_pic_num; /**< It sets the number of pictures to apply the given delta QP. */
    int             dqp[8];          /**< A delta QP */
    int             HvsQpScaleDiv2;  /**< It specifies the scale for MB QP derivation. It is only avilable when EN_HVS_QP is 1. */
    int             EnHvsQp;         /**< It enables HVS QP. */
    int             EnRowLevelRc;    /**< It enables row-level rate control. */
