...
extern DECL_EXPORT int vdi_clear_memory(unsigned long core_idx, PhysicalAddress addr, int len, int endian);
extern DECL_EXPORT int vdi_set_memory(unsigned long core_idx, PhysicalAddress addr, int len, int endian, Uint32 data);
extern DECL_EXPORT int vdi_write_memory(unsigned long core_idx, PhysicalAddress addr, unsigned char *data, int len, int endian);
extern DECL_EXPORT int vdi_read_memory(unsigned long core_idx, PhysicalAddress addr, unsigned char *data, int len, int endian);
...
extern u64 vdi_get_virt_addr(u64 core_idx, u64 addr);
extern void vdi_invalidate_memory(u64 core_idx, vpu_buffer_t *vb);

extern int vdi_get_in_num(unsigned int core_idx, unsigned int inst_idx);
