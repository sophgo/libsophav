...
// DO NOT EDIT
// C++ Class with SceMi Message passing for type:  TLM3Api::TLMResponseHeader
...
/// C++ class representing the hardware structure TLM3Api::TLMResponseHeader
class TLMResponseHeader : public XATType {
 public:
  TLMResponseParams m_params ;
  BitT<15> m_b_length ;
   ...
   */
  TLMResponseHeader ( const SceMiMessageDataInterface *msg, unsigned int &off )
    : m_params(msg, off)
    , m_b_length(msg, off)
  {}
  ...
  /// overload the put-to operator for TLMResponseHeader
  friend std::ostream & operator<< (std::ostream &os, const TLMResponseHeader &obj) {
  ...
  virtual XATType * getMember (unsigned int idx) {
    switch (idx) {
      ...
      default: std::cerr << "Index error in getMember for class TLMResponseHeader" << std::endl ;
    };
    return 0;
  };
  ...
  virtual const char * getMemberName (unsigned int idx) const {
    switch (idx) {
      ...
      default: std::cerr << "Index error in getMemberName for class TLMResponseHeader" << std::endl ;
    };
    return 0;
  };
};
