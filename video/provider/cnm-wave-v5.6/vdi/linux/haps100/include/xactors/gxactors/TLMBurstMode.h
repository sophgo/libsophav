...
// DO NOT EDIT
// C++ Class with SceMi Message passing for type:  TLM3Defines::TLMBurstMode

#pragma once

#include "bxactors/xat_scemi.h"

/// C++ class representing the hardware enum TLM3Defines::TLMBurstMode.
class TLMBurstMode : public XATType {
 public:
  enum E_TLMBurstMode {
      e_INCR,
      e_WRAP,
  ...
  E_TLMBurstMode m_val;

  /// Default constructor for enumeration
  TLMBurstMode (E_TLMBurstMode v = e_INCR)
  : m_val(v)
  {}
   ...
   */
  TLMBurstMode (const SceMiMessageDataInterface *msg, unsigned int & off) {
    m_val = (E_TLMBurstMode) msg->GetBitRange ( off, 1 );
    off = off + 2;
  }
  ...
  bool operator== (const E_TLMBurstMode &x) const { return m_val == x ;}
  /// overload operator != for enumeration classes with values
  bool operator!= (const E_TLMBurstMode &x) const { return m_val != x ;}
  /// overload operator == for enumeration classes
  bool operator== (const TLMBurstMode &x) const { return m_val == x.m_val ;}
  /// overload operator != for enumeration classes
  bool operator!= (const TLMBurstMode &x) const { return m_val != x.m_val ;}

  /// overload the put-to operator for TLMBurstMode
  friend std::ostream & operator<< (std::ostream &os, const TLMBurstMode & e) {
    XATType::PutTo * override = lookupPutToOverride ( e.getClassName() );
    if ( override != 0 ) {
       return override(os, e );
    }
    switch (e.m_val) {
      case e_INCR: os << "INCR" ; break ;
      case e_WRAP: os << "WRAP" ; break ;
      case e_CNST: os << "CNST" ; break ;
      case e_UNKNOWN: os << "UNKNOWN" ; break ;
      default: os << "Enum value error for TLMBurstMode: " << (int) e.m_val << "." ;
    }
    return os;
  };
  ...
  const char * getName() const {
    const char *ret = "" ;
    switch (m_val) {
      case e_INCR: ret = "INCR" ; break ;
      case e_WRAP: ret = "WRAP" ; break ;
      case e_CNST: ret = "CNST" ; break ;
      case e_UNKNOWN: ret = "UNKNOWN" ; break ;
      default: std::cerr << "Enum value error for TLMBurstMode: " << (int) m_val << "." ;
    }
    return ret;
  };
