...
extern Comparator Comparator_Create(
    Uint32    type,               //!<<   1: yuv
    char* goldenPath,
    ...
    );

extern BOOL Comparator_Destroy(
    Comparator  comp
    );

extern BOOL Comparator_Act(
    Comparator  comp,
    void*       data,
    Uint32      size,
    Uint32      insNum
...
extern BOOL Comparator_CheckFrameCount(
    Comparator  comp
    );

extern BOOL Comparator_SetScanMode(
    Comparator  comp,
    BOOL        enable
    );

extern BOOL Comparator_Rewind(
    Comparator  comp
    );

extern BOOL Comparator_CheckEOF(
    Comparator  comp
    );

extern Uint32 Comparator_GetFrameCount(
    Comparator comp
    );

extern BOOL Comparator_Configure(
    Comparator              comp,
...
extern int ProcessEncodedBitstreamBurst(
    Uint32 core_idx,
    osal_file_t fp,
    int targetAddr,
 ...
 */
extern BitstreamReader BitstreamReader_Create(
    Uint32    type,
    char*       path,
    EndianMode  endian,
    EncHandle*  handle
 ...
 */
extern BOOL BitstreamReader_Act(
...
extern BOOL BitstreamReader_Destroy(
    BitstreamReader reader
    );
...
extern Renderer SimpleRenderer_Create(
    DecHandle           decHandle,
    RenderDeviceType    deviceType,
    const char*         yuvPath            //!<< path to store yuv iamge.
    );

extern Uint32 SimpleRenderer_Act(
    Renderer        renderer,
...
extern void* SimpleRenderer_GetFreeFrameInfo(
    Renderer        renderer
    );

/* \brief       Flush display queues and clear display indexes
 */
extern void SimpleRenderer_Flush(
    Renderer        renderer
    );

extern BOOL SimpleRenderer_Destroy(
    Renderer    renderer
    );

extern BOOL SimpleRenderer_SetFrameRate(
    Renderer        renderer,
    Uint32          fps
    );
...
extern int ParseChangeParamCfgFile(
    ParamChange* pEncCfg,
    char*        FileName
    );
#ifdef __cplusplus
...
extern RetCode SetCoda9ChangeParam(
    EncHandle handle,
    TestEncConfig* encConfig,
    BOOL fieldDone
    );
...
extern int parse_custom_lambda(Uint32 buf[NUM_CUSTOM_LAMBDA], FILE* fp);
